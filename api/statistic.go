...
func (l *Launcher) Total() (result TotalResult) {
	result.bytesSentUint64, result.bytesReceivedUint64 = transport.GlobalStats.Total()
...
func (l *Launcher) Speed() (result SpeedResult) {
	result.BytesSent, result.BytesReceived = transport.GlobalStats.CalculateSpeed()
	return result
}
